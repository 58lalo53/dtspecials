 ...
 */
@Entity
@Table(name = "REVIEWS", catalog = "", schema = "DTSPECIALS")
@NamedQueries({
    @NamedQuery(name = "Review.findAll", query = "SELECT r FROM Review r"),
    @NamedQuery(name = "Review.findById", query = "SELECT r FROM Review r WHERE r.id = :id"),
    @NamedQuery(name = "Review.findByPost", query = "SELECT r FROM Review r WHERE r.post = :post"),
    @NamedQuery(name = "Review.findByRdate", query = "SELECT r FROM Review r WHERE r.rdate = :rdate")})
public class Review implements Serializable {
    ...
    public Review(Integer id, String post, Date rdate) {
        this.id = id;
        this.post = post;
        this.rdate = rdate;
    }
    ...
    public String toString() {
        return "com.dtspecials.mavendtspecials.Review[ id=" + id + " ]";
    }
